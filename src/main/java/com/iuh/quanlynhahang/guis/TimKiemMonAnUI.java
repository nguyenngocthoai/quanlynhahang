			...
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
									...
									.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
										.addGroup(gl_contentPane.createSequentialGroup()
											...
											.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
												...
												.addComponent(rdbTen, GroupLayout.PREFERRED_SIZE, 59, GroupLayout.PREFERRED_SIZE)))
										.addGroup(gl_contentPane.createSequentialGroup()
											...
											.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
												.addGroup(gl_contentPane.createSequentialGroup()
													...
													.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
														.addGroup(gl_contentPane.createSequentialGroup()
															.addComponent(lblT, GroupLayout.PREFERRED_SIZE, 62, GroupLayout.PREFERRED_SIZE)
															.addGap(18)
															.addComponent(txtGiaFrom, GroupLayout.DEFAULT_SIZE, 260, Short.MAX_VALUE))
														.addGroup(gl_contentPane.createSequentialGroup()
															.addComponent(lbln, GroupLayout.PREFERRED_SIZE, 53, GroupLayout.PREFERRED_SIZE)
															.addGap(27)
															.addComponent(txtGiaTo, GroupLayout.DEFAULT_SIZE, 260, Short.MAX_VALUE))))
												.addComponent(lblGiTin, GroupLayout.PREFERRED_SIZE, 64, GroupLayout.PREFERRED_SIZE)
												.addGroup(gl_contentPane.createSequentialGroup()
													.addComponent(lblSinThoi, GroupLayout.PREFERRED_SIZE, 106, GroupLayout.PREFERRED_SIZE)
													.addPreferredGap(ComponentPlacement.RELATED)
													.addComponent(cboLoai, 0, 260, Short.MAX_VALUE)
													.addGap(3))
												.addGroup(gl_contentPane.createSequentialGroup()
													.addComponent(lblTnKhchHng, GroupLayout.PREFERRED_SIZE, 110, GroupLayout.PREFERRED_SIZE)
													.addPreferredGap(ComponentPlacement.RELATED)
													.addComponent(txtTen, GroupLayout.DEFAULT_SIZE, 259, Short.MAX_VALUE)))))
									.addGap(47))
								.addGroup(gl_contentPane.createSequentialGroup()
									.addGap(212)
						...
						.addGroup(gl_contentPane.createSequentialGroup()
							.addGap(389)
							.addComponent(lblTmKimKhch, GroupLayout.PREFERRED_SIZE, 300, GroupLayout.PREFERRED_SIZE)))
					.addGap(26))
		);
							...
							.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(gl_contentPane.createSequentialGroup()
									...
									.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
										.addComponent(rdbGiaTien, GroupLayout.PREFERRED_SIZE, 29, GroupLayout.PREFERRED_SIZE)
										.addComponent(rdbLoai)))
								.addComponent(rdbTen))
							.addGap(11)
							.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
