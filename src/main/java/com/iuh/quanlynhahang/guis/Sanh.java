...
public class Sanh extends JFrame {
	...
	public Sanh() {
		...
		lblTiKhon.setFont(new Font("Times New Roman", Font.PLAIN, 20));
		 ...
		 lblDanhSchKhch = new JLabel("Danh Sách Các Sảnh Của Nhà Hàng :");
		...
		lblMTiKhon = new JLabel("Mã Sảnh : 1");
		...
		btnXaTiKhon = new JButton("Xóa Sảnh");
		...
		gl_contentPane.setHorizontalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(gl_contentPane.createSequentialGroup()
					.addGap(5)
					.addComponent(lblDanhSchKhch, GroupLayout.PREFERRED_SIZE, 249, GroupLayout.PREFERRED_SIZE)
