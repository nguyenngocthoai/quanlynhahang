...
//		setEnabled(false);
		...
		String[] header = "STT;Mã Nhân Viên; Tên Nhân Viên;Giới Tính;Số Điện Thoại;Tình Trạng".split(";");
				...
				.addGroup(gl_contentPane.createSequentialGroup()
					.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
						...
						.addGroup(gl_contentPane.createSequentialGroup()
							.addGap(5)
							.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
								.addComponent(panel, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 630, Short.MAX_VALUE)
		...
		gl_panel_1.setHorizontalGroup(
			gl_panel_1.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_panel_1.createSequentialGroup()
					.addGap(119)
					.addComponent(lblThngTinKhch, GroupLayout.DEFAULT_SIZE, 249, Short.MAX_VALUE)
					.addGap(77))
				.addGroup(gl_panel_1.createSequentialGroup()
					.addContainerGap()
					...
					.addPreferredGap(ComponentPlacement.RELATED)
					.addComponent(cbxTrangThai, 0, 310, Short.MAX_VALUE)
					.addGap(16))
				.addGroup(gl_panel_1.createSequentialGroup()
					.addContainerGap()
								...
								.addGroup(gl_panel_1.createSequentialGroup()
									.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
										.addGroup(gl_panel_1.createParallelGroup(Alignment.TRAILING)
											.addGroup(gl_panel_1.createSequentialGroup()
												.addComponent(lblMKhchHng_3, GroupLayout.PREFERRED_SIZE, 99, GroupLayout.PREFERRED_SIZE)
												.addPreferredGap(ComponentPlacement.UNRELATED))
											.addGroup(gl_panel_1.createSequentialGroup()
												.addComponent(lblNewLabel_1, GroupLayout.PREFERRED_SIZE, 72, GroupLayout.PREFERRED_SIZE)
												.addGap(28)))
										.addComponent(lblMKhchHng_2)
										.addComponent(lblMKhchHng_1, GroupLayout.PREFERRED_SIZE, 71, GroupLayout.PREFERRED_SIZE)
									...
									.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
										.addGroup(gl_panel_1.createSequentialGroup()
											...
											.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
												...
												.addComponent(txtTenNV, GroupLayout.DEFAULT_SIZE, 273, Short.MAX_VALUE)
												.addGroup(gl_panel_1.createSequentialGroup()
													.addComponent(rdbNam, GroupLayout.PREFERRED_SIZE, 63, GroupLayout.PREFERRED_SIZE)
													.addGap(59)
													.addComponent(rdbNu, GroupLayout.PREFERRED_SIZE, 57, GroupLayout.PREFERRED_SIZE)
													.addPreferredGap(ComponentPlacement.RELATED, 94, Short.MAX_VALUE))))
										.addComponent(cboLoaiNV, 0, 273, Short.MAX_VALUE)
										.addComponent(dateNgaySinh, GroupLayout.DEFAULT_SIZE, 273, Short.MAX_VALUE)))
								.addGroup(gl_panel_1.createSequentialGroup()
									.addComponent(lblMKhchHng_5, GroupLayout.PREFERRED_SIZE, 99, GroupLayout.PREFERRED_SIZE)
									.addPreferredGap(ComponentPlacement.UNRELATED)
									.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
										.addComponent(txtEmail, Alignment.TRAILING)
										.addComponent(txtSDT, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 276, Short.MAX_VALUE))))
							.addPreferredGap(ComponentPlacement.RELATED)))
					.addGap(16))
		);
			...
			if (row != -1) {
				...
				if (check == false) {
					...
					try {
						...
						NhanVien nv = new NhanVien(maNV, tenNV, ngaySinhsql, gioiTinh, diaChi, sDT, trangThai, email,
								taiKhoan);
...
//				txtTenNV.selectAll();
				...
				try {
					LoaiTaiKhoan loaiTaiKhoan = loaiTaiKhoanDAO.getLTKByTenLTK(cboLoaiNV.getSelectedItem().toString());
					TaiKhoan taiKhoan = new TaiKhoan(taiKhoanUI.randomMaTKNotExisted(), loaiTaiKhoan, txtMaNV.getText(),
							passwordDefault);
		...
		try {
			...
			for (NhanVien nv : nhanViens) {
				...
				tableModel.addRow(new Object[] { i, nv.getMaNhanVien(), nv.getHoTenNhanVien(), nv.getGioiTinh(),
						nv.getSoDienThoai(), nv.getTinhTrang() });
			}
...
//		setEnabled(false);
		...
		lblThngTinKhch = new JLabel("Thông Tin Nhân Viên");
		lblThngTinKhch.setBounds(120, 10, 217, 24);
		lblThngTinKhch.setForeground(Color.BLACK);
		lblThngTinKhch.setFont(new Font("Times New Roman", Font.BOLD, 20));

		lblMNhnVin = new JLabel("Mã Nhân Viên");
		lblMNhnVin.setBounds(11, 41, 105, 24);
		lblMNhnVin.setFont(new Font("Times New Roman", Font.PLAIN, 16));

		lblTnNhnVin = new JLabel("Tên Nhân Viên");
		lblTnNhnVin.setBounds(11, 75, 112, 24);
		lblTnNhnVin.setFont(new Font("Times New Roman", Font.PLAIN, 16));

		lblMKhchHng_1 = new JLabel("Địa Chỉ");
		lblMKhchHng_1.setBounds(11, 117, 71, 24);
		lblMKhchHng_1.setFont(new Font("Times New Roman", Font.PLAIN, 16));

		lblMKhchHng_2 = new JLabel("Giới Tính");
		lblMKhchHng_2.setBounds(11, 182, 62, 24);
		lblMKhchHng_2.setFont(new Font("Times New Roman", Font.PLAIN, 16));

		lblMKhchHng_3 = new JLabel("Ngày Sinh");
		lblMKhchHng_3.setBounds(12, 219, 99, 24);
		lblMKhchHng_3.setFont(new Font("Times New Roman", Font.PLAIN, 16));

		lblMKhchHng_5 = new JLabel("Số Điện Thoại");
		lblMKhchHng_5.setBounds(11, 257, 99, 24);
		lblMKhchHng_5.setFont(new Font("Times New Roman", Font.PLAIN, 16));

		lblMKhchHng_6 = new JLabel("Email");
		lblMKhchHng_6.setBounds(11, 291, 105, 24);
		lblMKhchHng_6.setFont(new Font("Times New Roman", Font.PLAIN, 16));

		txtTenNV = new JTextField();
		txtTenNV.setBounds(123, 75, 275, 24);
		txtTenNV.setFont(new Font("Times New Roman", Font.PLAIN, 16));
		txtTenNV.setColumns(10);

		txtDiaChi = new JTextField();
		txtDiaChi.setBounds(123, 117, 275, 24);
		txtDiaChi.setFont(new Font("Times New Roman", Font.PLAIN, 16));
		txtDiaChi.setColumns(10);

		txtSDT = new JTextField();
		txtSDT.setBounds(120, 257, 278, 24);
		txtSDT.setFont(new Font("Times New Roman", Font.PLAIN, 16));
		txtSDT.setColumns(10);

		txtEmail = new JTextField();
		txtEmail.setBounds(120, 291, 278, 24);
		txtEmail.setFont(new Font("Times New Roman", Font.PLAIN, 16));
		txtEmail.setColumns(10);

		rdbNam = new JRadioButton("Nam");
		rdbNam.setBounds(123, 184, 63, 21);
		rdbNam.setSelected(true);
		rdbNam.setFont(new Font("Times New Roman", Font.PLAIN, 16));

		rdbNu = new JRadioButton("Nữ");
		rdbNu.setBounds(245, 184, 57, 21);
		rdbNu.setFont(new Font("Times New Roman", Font.PLAIN, 16));
		ButtonGroup buttonGroup = new ButtonGroup();
		buttonGroup.add(rdbNam);
		buttonGroup.add(rdbNu);
		...
		txtMaNV = new JTextField();
		txtMaNV.setBounds(126, 41, 272, 24);
		txtMaNV.setFont(new Font("Times New Roman", Font.PLAIN, 16));
		txtMaNV.setEditable(false);
		txtMaNV.setColumns(10);

		lblNewLabel = new JLabel("Trạng Thái\r\n");
		lblNewLabel.setBounds(11, 327, 105, 20);
		lblNewLabel.setFont(new Font("Times New Roman", Font.PLAIN, 16));

		cbxTrangThai = new JComboBox();
		cbxTrangThai.setBounds(120, 325, 278, 25);
		cbxTrangThai.setFont(new Font("Times New Roman", Font.PLAIN, 16));

		dateNgaySinh = new JDateChooser();
		dateNgaySinh.setBounds(123, 216, 275, 27);
		dateNgaySinh.getCalendarButton().setFont(new Font("Times New Roman", Font.PLAIN, 16));
		dateNgaySinh.setLocale(Locale.forLanguageTag("vi-VN"));
		dateNgaySinh.setDateFormatString("dd-MM-yyyy");

		JLabel lblNewLabel_1 = new JLabel("Loại NV");
		lblNewLabel_1.setBounds(11, 152, 72, 20);
		lblNewLabel_1.setFont(new Font("Times New Roman", Font.PLAIN, 16));

		cboLoaiNV = new JComboBox();
		cboLoaiNV.setBounds(123, 151, 275, 25);
		...
		panel_1.add(rdbNam);
		panel_1.add(rdbNu);
		panel_1.add(cboLoaiNV);
		panel_1.add(dateNgaySinh);
